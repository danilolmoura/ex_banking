defmodule Type do
  ...
  defguard validate_params(from_user, to_user, amount, currency) when is_binary(from_user) and is_binary(to_user) and is_binary(currency) and is_float(amount) and amount >= 0
end
